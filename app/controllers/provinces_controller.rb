class ProvincesController < ApplicationController
  ...
  def index
    @provinces = Province.order(:name).page(params[:page]).per(10)
  end
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to provinces_path, status: :see_other, notice: "Province was successfully destroyed." }
  ...
  private
    ...
    def province_params
      params.require(:province).permit(:name, :description, :remarks)
    end
end
